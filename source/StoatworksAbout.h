/*
 * Stoatworks Labs - About window data for Graticule.
 *
 * PROVISIONAL, hand-written in the shape stoatworks-backend/scripts/sync-about.py
 * generates. Graticule is not yet registered in the website's projects.json, so
 * the sync cannot produce this file; once it is, `sync-about.py --only
 * graticule --apply` overwrites this with the generated copy. The facts below
...
{
    inline constexpr auto name = "Graticule";
    inline constexpr auto slug = "graticule";
    inline constexpr auto hook = "Test patterns and LED grids for Resolume";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "";
    inline constexpr auto page = "https://stoatworks-labs.com/software/graticule/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/graticule";
